...
def get_filters():
    ...
    # Created a while loop asking for user input
    while True:
        try:
            city_input = input('Please select chicago, new york city or washington: ')
...
def display_raw_data(df):
    ...
    raw_data_input = input('Would you like to see 5 lines of raw data?: ')
    while raw_data_input == 'yes':
        five_rows = df.iloc[start:end]
        print(five_rows)
        start +=5
        end +=5
        another_five = input('Do you want to see another five lines?: ')
        if another_five == 'yes':
            print(five_rows)
        else:
            break
...
def get_filters():
    ...
    # TO DO: get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    # Created a while loop asking for user input
    # Take user input and make all lower_case
    while True:
        try:
